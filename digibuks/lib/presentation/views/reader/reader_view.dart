            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontWeight: FontWeight.bold,
                  color:
                      controller.isDarkMode ? Colors.white70 : Colors.black54,
                ),
              ),
            ],
          ),
                    ...
                    : SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (controller.currentChapterIndex ==
                                controller.totalChapters - 1)
                              Center(
                                child: Column(
                                  children: [
                  ...
                  child: controller.bookmarks.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final location =
                                bookmark['location'] as Map<String, dynamic>?;
                  ...
                  Row(
                    children: [
                      _buildAlignButton('Left', 'left',
                          Icons.format_align_left_rounded, controller),
                      const SizedBox(width: 12),
                      _buildAlignButton('Justify', 'justify',
                          Icons.format_align_justify_rounded, controller),
                    ],
                  ),
                  const SizedBox(height: 24),
