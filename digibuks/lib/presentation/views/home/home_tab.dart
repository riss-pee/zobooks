...
class _HomeTabState extends State<HomeTab> {
  ...
  Widget build(BuildContext context) {
    // Controllers are initialized via HomeBinding (which is applied to the wrapper view)
    // or manually put. Assuming they are available.
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          elevation: 0,
          title: Text('DigiBuks', style: TextStyle(color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.bold)),
          actions: [
            IconButton(
              tooltip: 'Search',
